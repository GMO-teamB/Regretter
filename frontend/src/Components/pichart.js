...
export function PieChart(props){
    ...
    return (
      ...
      <Box position="relative" display="inline-flex" className="circleBox">
        ...
        <CircularProgress className="circle" variant="determinate" size={400} value={100} style={{'color': 'gray'}}/>
        {/* バロメーター用のCircularProgress */}
        <CircularProgress className="circle" variant="determinate" size={400} value={value} style={{'color': '#14b4c9'}}/>
